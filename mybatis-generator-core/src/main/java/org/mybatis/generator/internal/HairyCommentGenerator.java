...
//        compilationUnit.addFileCommentLine(" * ");
//        compilationUnit.addFileCommentLine(" * @author GengChao");
//        compilationUnit.addFileCommentLine(" * @email chao_geng@sui.com");
//        compilationUnit.addFileCommentLine(" * @date "+formatDate);
//        compilationUnit.addFileCommentLine(" */");
    ...
    public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        topLevelClass.addJavaDocLine(" * ");
        topLevelClass.addJavaDocLine(" * @author GengChao");
        topLevelClass.addJavaDocLine(" * @email chao_geng@sui.com");
        topLevelClass.addJavaDocLine(" * @date "+formatDate);
        topLevelClass.addJavaDocLine(" */");
